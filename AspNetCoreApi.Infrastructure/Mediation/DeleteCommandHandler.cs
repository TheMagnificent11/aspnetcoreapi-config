...
namespace AspNetCoreApi.Infrastructure.Mediation
{
    ...
    /// <typeparam name="THandler">Type of handler inheriting <see cref="DeleteCommandHandler{TId, TEntity, TRequest, THandler}"/></typeparam>
    public abstract class DeleteCommandHandler<TId, TEntity, TRequest, THandler> :
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DeleteCommandHandler{TId, TEntity, TRequest, THandler}"/> class
        /// </summary>
